        ...
        <div className="about">
            <Container>
                <Row>
                    ...
                    Social Events, and Career Preperation.</p>
                </Row>
                <Row>
                    <h1 className="about-h1">Our Mission</h1>
                    <p className="about-p">“The purpose of the CSC is to foster a community for RIT's 
                    computing students and provide them with the resources and skills necessary to 
                    succeed, both academically and professionally.”</p>
                </Row>
                <Row>
                    <h1 className="about-h1">What We Do</h1>
                    <p className="about-p last">We hold events related to each pillar and offer a space to 
